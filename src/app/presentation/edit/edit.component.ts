...
export class EditComponent implements OnInit {
    ...
    constructor(private fb: FormBuilder, private route: ActivatedRoute, private http: HttpClient, private router: Router, private socketService: SocketService, private toastr: ToastrService) {
    ...
    onSelectedFile(event) {
        if (event.target.files.length != 0) {
            ...
            this.profileForm.get('upload_file').setValue(file);
        }
    }
    ...
    onSubmit() {
        ...
        this.http.post(environment.apiRoot + 'upload_file.php', formData, {
